...
export const STRINGS = {
  ja: {
    ...
    speed: "速度 v",
    radius: "ターン半径 R",
    radiusHint: "apex（一番きつい所）の半径。円で見たときの半径",
    length: "1ターンの長さ（縦）",
    lengthHint: "1ターンで進む降下方向の距離。深さ φ = L/(2R) で決まる",
    mass: "質量 m",
    derivedDepth: "ターンの深さ φ ≈",
    derivedWidth: "ターン幅 ≈",
  ...
  en: {
    ...
    slope: "Slope angle α",
    speed: "Speed v",
    radius: "Turn radius R",
    radiusHint: "Radius at apex (tightest point). The radius seen as a circle",
    length: "Turn length (downhill)",
    lengthHint: "Downhill distance per turn. Depth φ = L/(2R)",
    mass: "Mass m",
    derivedDepth: "Turn depth φ ≈",
    derivedWidth: "Turn width ≈",
