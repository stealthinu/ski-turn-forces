...
export const STRINGS = {
  ja: {
    ...
    speed: "速度 v",
    radius: "ターン横幅 R（半幅）",
    radiusHint: "ターンの横の張り出し（半幅）。長さを変えても不変",
    length: "1ターンの長さ（縦）",
    lengthHint: "1ターンの降下距離。長いほど弧は浅く（深さ φ が小さく）なる",
    mass: "質量 m",
  ...
  en: {
    ...
    slope: "Slope angle α",
    speed: "Speed v",
    radius: "Turn width R (half)",
    radiusHint: "Lateral reach (half-width). Stays fixed as length changes",
    length: "Turn length (downhill)",
    lengthHint: "Downhill distance per turn. Longer = shallower (smaller φ)",
    mass: "Mass m",
