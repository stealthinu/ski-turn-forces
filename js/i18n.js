...
export const STRINGS = {
  ja: {
    ...
    radius: "ターン半径 R",
    turnAngle: "1ターン角 θ",
    turnAngleHint: "1ターンで進行方向が変わる角度（弧長 = R×θ）",
    mass: "質量 m",
    derivedArc: "1ターン弧長 ≈",
    derivedArcNote: "（R×θ から自動計算）",
  ...
  en: {
    ...
    turnAngle: "Turn angle θ",
    turnAngleHint: "Heading change per turn (arc length = R×θ)",
    mass: "Mass m",
    derivedArc: "Arc length per turn ≈",
    derivedArcNote: "(auto from R×θ)",
