...
export const STRINGS = {
  ja: {
    ...
    speed: "速度 v",
    radius: "ターン半径 R（apex）",
    turnLength: "1ターンの降下距離 λ",
    turnLengthHint: "進行（降下）方向に1サイクル進む距離",
    mass: "質量 m",
    derivedAmp: "算出横振幅 A ≈",
    derivedNote: "（R と λ から自動計算）",
  ...
  en: {
    ...
    turnLength: "Downhill distance per turn λ",
    turnLengthHint: "Distance traveled downhill for one full turn cycle",
    mass: "Mass m",
    derivedAmp: "Lateral amplitude A ≈",
    derivedNote: "(auto from R and λ)",
